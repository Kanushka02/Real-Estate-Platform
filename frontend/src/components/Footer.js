        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Find your dream property in Sri Lanka. Buy, sell, or rent with confidence.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400">Email: info@realestate.lk</p>
            <p className="text-gray-400">Phone: +94 11 234 5678</p>
            <p className="text-gray-400">Address: Colombo, Sri Lanka</p>
          </div>
        </div>
